...
export function Footer() {
  ...
  return (
    <footer className="footer-container">
      ...
      {localStorage.getItem("subscribeInfo") === null && (
      ...
      <div className="social-networks-footer">
        ...
        <a href={ong.twitter_url} className="footer-link">
          <TwitterOutlined />
        </a>
        <a href={ong.facebook_url} className="footer-link">
          <FacebookOutlined />
        </a>
        <a href={ong.instagram_url} className="footer-link">
          <InstagramOutlined />
        </a>
        <a href={ong.linkedin_url} className="footer-link">
          <LinkedinOutlined />
        </a>
      </div>
    </footer>
