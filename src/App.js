...
import { Home, Login, About, Contact, Thanks, Error404,Register,
         BackOfficeDashboard, 
         UsersTable, UserForm,
         CategoriesList, SlidesList, MembersList,
         OrganizationInfo,
         News, NewsTable } from './Pages';

import { ActivitiesForm, ActivityDetail, ActivitiesList, 
         HomeForm, Edit, Layout,
         CategoriesForm,
         NewsForm, NewsDetail, 
         SlidesForm, 
         TestimonialForm, 
         MembersForm, ListMembers, 
         ProjectsForm } from './Components';
